...
namespace KulibinSpace.MessageBus {
  ...
  */
    /*********************** COMPONENT SIGNAL **********************/
    //[System.Serializable] public class ComponentEvent : UnityEvent<MonoBehaviour> { }
    /*
        [Serializable]
        ...
        */
        ...
        public void Subscribe () {
            ...
            foreach (var item in entries) {
                item.eventItem.Subscribe(item.gameMessage);
            }
            subscribed = true;
        }
        ...
        public void Unsubscribe () {
            if (!subscribed) return;
            foreach (var item in entries) {
                item.eventItem.Unsubscribe(item.gameMessage);
            }
            subscribed = false;
        }
